...
for(kfold in 1:5){
  ...
  #step2 Ie!P!L¢FG?¢FXNxO2!POIaA?2?!PO,!PO!Oe?AEa3oE!PCD1U2a¢Gg?¢GgAY¢FG?OO?¢FXcensorY¢FG?OAL!¢FFR!¢FFuA!|1A?A!¢FG
  #X1<-X
  ...
  for(cc in 1:length(eta)){
    ...
    for(i in 1:B){
      ...
      for(s in 1:length(Xchange1[,1])){
        ...
        #D!|O?!Mo1¢FGop¢GgA?OE|¢FG?¢FXN38!Mo!OaEy¢FXuOUAiAa¢FG?A?O?!Mo??!MA
